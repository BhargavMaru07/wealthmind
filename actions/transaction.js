...
export async function scanReceipt(file) {
  try {
    ...
    console.error("Error in scanRecipt function");
...
export async function getTransaction(id) {
  try {
    ...
    if (!transaction) throw new Error("Transaction is not found");

    return serializeAmount(transaction);
  } catch (error) {
    console.error("Error in getting transaction for edit");
    throw new Error(error.message);
  }
}
...
export async function updateTransaction(id, data) {
  try {
    ...
    if (!originalTransaction) throw new Error("Transaction is not found");
    ...
    //update transaction and update account balance in a transaction
    const transaction = await db.$transaction(async (tx) => {
